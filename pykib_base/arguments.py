...
def getArgumentParser():
    ...
    parser.add_argument("-sbl", "--setbrowserlanguage", dest="setBrowserLanguage", default="en", help="Overrides the default Browser Language in format de (for German), en (for English)....")
    parser.add_argument("-scua", "--setCitrixUserAgent", dest="setCitrixUserAgent", nargs='?', const=True, default=False, help="Overrides the default UserAgent for skipping citrix receivers client detection")
